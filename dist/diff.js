        ...
        for (let definition of definitions) {
            ...
            if (asn1Old[moduleName] && asn1New[moduleName]) {
                ...
                if (isJsonEmpty(diffJsonResult)) {
                    ...
                    let patch = jsdiff.createTwoFilesPatch(`${definition}`, `${definition}`, formatter.format(definition, asn1Old, true, 'txt'), formatter.format(definition, asn1New, true, 'txt'), '(old)', '(new)', { context: 9999 });
                    listModified.push({
